...
public class MainTest {
    ...
    public static void main(String[] args) {
        ...
        DecoratorStream bufferStream = new BufferStream(stream);//缓冲流操作
        DecoratorStream cryptoStream = new CryptoStream(stream);//加密流操作
        DecoratorStream cryptoAndBuffer = new BufferStream(cryptoStream);//加密 缓冲流
